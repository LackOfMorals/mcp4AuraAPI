...
echo ""
echo "Outcomes available (8 total):"
echo "  Instance Management:"
echo "    - list-instances"
echo "    - get-instance-details (NEW - includes Prometheus URL!)"
...
echo "   a. Call 'list-outcomes' - should show 8 outcomes"
echo "   b. Call 'get-instance-details' to get Prometheus URL"
echo "   c. Call 'get-instance-health' with that URL"
echo ""
